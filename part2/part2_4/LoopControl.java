...
public class LoopControl {
    public static void main(String[] args) {
        ...
        // ▼ ВАШ КОД ЗДЕСЬ ▼
        // 1) continue - пропускает оставшуюся часть тела цикла и сразу переходит к следующей итерации.
        // 2) break - останавливает только ближайший цикл
        // 3) break label - выходит сразу из указанного внешнего цикла
        // ▲ КОНЕЦ ВАШЕГО КОДА ▲
    }
}
